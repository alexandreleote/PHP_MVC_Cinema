...
<section class="film-detail-container">
    <article class="film-header" style="background-image: url('<?= $details["bg"] ?>');">
        <div class="film-content">
            <div class="film-poster-container">
                <img src="<?= $details["photo"] ?>" alt="<?= $details["realisateur"] ?>" class="film-poster">
            </div>
            <div class="film-info">
                <h1 class="film-title"><?= $details["realisateur"] ?></h1>
    ...
    <section class="film-credits">
        <article class="credits-section filmography">
            <h2 class="credits-title">Filmographie en tant que réalisateur</h2>
    ...
    <a href="index.php?action=editRealisateur&id=<?= $details["id_realisateur"] ?>" class="btn-edit">Modifier</a>
</section>
